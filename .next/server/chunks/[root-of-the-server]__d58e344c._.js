...
"[project]/.next-internal/server/app/api/create-user/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/create-user/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const userRecord = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2d$admin__$5b$external$5d$__$28$firebase$2d$admin$2c$__cjs$29$__["auth"])().createUser({
            email,
            password,
            displayName: name
        });
        // Add user to Firestore with role 'employee'
        await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2d$admin__$5b$external$5d$__$28$firebase$2d$admin$2c$__cjs$29$__["firestore"])().collection('users').doc(userRecord.uid).set({
            id: userRecord.uid,
            name,
            email,
            role: 'employee',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d58e344c._.js.map