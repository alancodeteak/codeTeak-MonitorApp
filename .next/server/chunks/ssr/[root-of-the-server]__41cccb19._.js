...
function LoginForm() {
    ...
    const onLoginSubmit = async (values)=>{
        setLoading(true);
        try {
            await setPersistence(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["auth"], browserLocalPersistence);
            const userCredential = await signInWithEmailAndPassword(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["auth"], values.email, values.password);
            const user = userCredential.user;
            const userDocRef = doc(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"], "users", user.uid);
    ...
    const onSignupSubmit = async (values)=>{
        ...
        try {
            await setPersistence(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["auth"], browserLocalPersistence);
            const userCredential = await createUserWithEmailAndPassword(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["auth"], values.email, values.password);
            const user = userCredential.user;
            const newUser = {
                id: user.uid,
                name: values.name,
            ...
            await setDoc(doc(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"], "users", user.uid), newUser);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__41cccb19._.js.map